...
contract Gin1689Coin is ControllableUpgradeable, ERC20PermitUpgradeable {
    ...
    function initialize(address _treasury, address _recipient, uint _defaultLPWANFee) external initializer {
        __Controllable_init();
        __ERC20_init("Gin1689 Coin", "GIN1689");
        __ERC20Permit_init("GIN1689");
        treasury = _treasury;
...
contract ProxiedGin1689Coin is Proxied, UUPSUpgradeable, Gin1689Coin  {
