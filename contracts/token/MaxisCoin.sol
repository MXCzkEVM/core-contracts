...
contract MaxisCoin is ControllableUpgradeable, ERC20PermitUpgradeable {
    ...
    function initialize(address _treasury, address _recipient, uint _defaultLPWANFee) external initializer {
        __Controllable_init();
        __ERC20_init("Maxis Coin", "MAXIS");
        __ERC20Permit_init("MAXIS");
        treasury = _treasury;
...
contract ProxiedMaxisCoin is Proxied, UUPSUpgradeable, MaxisCoin  {
