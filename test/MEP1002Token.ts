...
import { MEP1002TokenMock } from '../typechain-types';
...
async function parentChildFixture(): Promise<{
  parent: MEP1002TokenMock;
  child: MEP1002TokenMock;
}> {
  const factory = await ethers.getContractFactory('MEP1002TokenMock');
...
describe('MEP1002Token', function () {
  let parent: MEP1002TokenMock;
  let child: MEP1002TokenMock;
